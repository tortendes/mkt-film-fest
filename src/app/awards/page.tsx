...
export default function Home() {
  return (
    <main className={`${montserrate.className} min-h-screen`}>
      ...
      <h1 className='w-full text-center font-bold text-2xl my-4'>Thank you all for participating, to see the winners of the awards, click <Link href="/awards/winners" className='text-custom-gold'>here</Link>.</h1>
